...
echo apply_filters( 'woocommerce_loop_add_to_cart_link',
	sprintf( '<button href="%s" rel="nofollow" data-product_id="%s" data-product_sku="%s" data-quantity="%s" class="%s product_type_%s" data-loading-text="Loading..." autocomplete="off">%s</button>',
		...
		$product->is_purchasable() && $product->is_in_stock()
			? 'btn btn-inverse btn-block add_to_cart_button'
