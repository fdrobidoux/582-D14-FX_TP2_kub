			...
			<div id="review_form">
				<?php
					...
					if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
						$comment_form['comment_field'] = '<div class="comment-form-rating"><label class="control-label" for="rating">' . __( 'Your Rating', 'woocommerce' ) .'</label><input name="rating" type="text" id="rating" value="0" /></div>';
					}

					$comment_form['comment_field'] .= '<div class=" form-group comment-form-comment"><label class="control-label" for="comment">' . __( 'Your Review', 'woocommerce' ) . '</label><textarea class="form-control" id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></div>';
